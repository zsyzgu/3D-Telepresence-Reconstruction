...
public:
	...
	~TsdfVolume();
	void integrate(byte* result, int cameras, float* depth_device, RGBQUAD** color, Transformation* depthTrans, Transformation* colorTrans, Intrinsics* depthIntrinsics, Intrinsics* colorIntrinsics);
