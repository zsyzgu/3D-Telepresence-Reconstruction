...
/*
=== Edited by zsyzgu ===
The full and origin code is as follow, which can procedure XYZ/XYZI/XYZRGB/XYZRGBA point clouds.
We only need XYZRGA in our project, so I cut other point clouds and improve the this program by filtering
========================
